						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="AmenityType" type="text" placeholder="Enter AmenityType" v-model="amenityToAdd.amenityType"></base-input>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Amenity Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Amenity Type</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="AmenityType" type="text" placeholder="Enter AmenityType" v-model="amenityDetails.amenityType"></input>
																		</div>
						</td>
														</tr>
															<tr> 
